...
public class Shigu {
	private Integer id;
	private String sgname;		//事故名称
	private String kstime;		//开始时间
	private String cxtime;		//持续时间
	private String address;		//事故地点
	private String qdtime;		//预案启动时间
	private String jytime;		//救援时间
	private Integer death;		//死亡
	private Integer injured;	//受伤
	private Integer shilian;	//失联
