...
<body>
	<div id="main-wrapper" style="height:880px; background-image: url(images/zoom-bg-7.jpg);background-repeat:no-repeat;
						...
						<div class="x_content">
							<div class="row">
                                <div class="black-bg col-sm-12 col-md-12 col-lg-12">
                                    <h2 class="text-center">煤炭通风与安全机制</h2>
                                    <div class="col-sm-12 col-md-12">
                                        <p>1、加强<a href="https://baike.baidu.com/item/%E7%85%A4%E7%9F%BF%E9%80%9A%E9%A3%8E/12199785?fr=aladdin">通风</a>。适当增加风量,
                                        	把这些有害气体排出或冲淡到《煤矿安全规程》规定的安全浓度以下,是常用也是有效防止井下有害气体危害的最根本的措施。</p>
                                        <p>2、加强检查,用各种瞧骷嗍泳赂髦钟泻宓亩以便及时采取相应的措施。</p>
                                        <p>3、如果某种有害气体的含量较大可采取抽放措施。如瓦斯抽放。</p>
                                        <p>4、井下通风不良的地区或不通风的旧巷道内积聚大量的有害气体。故在这些旧巷口要设栅栏,挂警标,防止他人误入。
                                        	如果必须进入,需要详细检查各种有害气体方可进入。</p>
                                        <p>5、若有人由于缺氧窒息或呼吸有毒有害气体中毒时立即将中毒者移到有新鲜空气的巷道或地面并进行人工呼吸
                                        	(NO2、H2S中毒除外)施行急救。</p>
                                    </div>
                                </div>
                            </div>
