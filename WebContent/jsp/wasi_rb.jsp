			...
			success:function(data){
				var wsrb = "<tr>";
		           $.each(data,function(index,item){
		        	 wsrb += "<td><input type='checkbox' class='flat' name='table_records'></td><td>"+item.id+"</td><td>"+item.didian+"</td><td>"+item.chuangan+"</td><td>"+item.banxie+"</td><td>"+item.guangan+"</td><td>"+item.eryanghuatan+"</td><td>"+item.wendu+"</td><td>"+item.shijian+"</td><td>"+item.zhuangtai+"</td><td><input type='button' value='审核' class='flat' ></td></tr>"
		           })
