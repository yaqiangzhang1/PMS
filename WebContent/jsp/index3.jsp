...
function addWeixian(){
    ...
    alert(cuoshi);
	$.ajax({
		url: "addWeixian?yinsu="+yinsu+"&houguo="+houguo+"&cuoshi="+cuoshi,
		type: "post",
		data: {},
...
function deleteWeixian(wxid){
	  alert(wxid)
		$.ajax({
			url: "deleteWeixian/"+wxid,
			type: "post",
			success: function(data){
				$("#ddgl").html(data);
			}
        ...
        <div class="right_col" role="main" style="margin-left: 0px">
          ...
          <div class="page-title">
			...
			<div class="form-group has-success">
				...
				<div class="col-sm-8">
					<input type="text"  required="true"  class="form-control" id="houguo"
						placeholder="后果" name="houguo" onchange="CheckChinese('test',this.value)">
				</div>
			</div>
			...
			<div class="form-group has-success">
				...
				<div class="col-sm-8">
					<input type="text"  required="true"  class="form-control" id="cuoshi"
						placeholder="措施" name="cuoshi" onchange="CheckChinese('test',this.value)"  >
				</div>
			</div>
			...
			<div class="col-sm-offset-2 col-sm-8">
					<button type="submit" class="btn btn-success" onclick="addWeixian()">提交</a></button>
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
				...
				<f:forEach items="${requestScope.list3}" var="wx">
                        <tr>
                          ...
                          <td><a href="javascript:deleteWeixian(${wx.wxid})" class="btn btn-xs btn-success">删除</a></td>
                        </tr>
                        </f:forEach>
			</tbody>
            </table>
